...
class GameServerObjectMeta(BaseModel):
    """
    ...
    deletion_timestamp: Optional[StrictStr] = None
    annotations: Optional[Dict[str, StrictStr]] = None
    labels: Optional[Dict[str, StrictStr]] = None
    __properties: ClassVar[List[str]] = ["name", "namespace", "uid", "resource_version", "generation", "creation_timestamp", "deletion_timestamp", "annotations", "labels"]
